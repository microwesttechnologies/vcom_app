...
class _ManagerBrandPageState extends State<ManagerBrandPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: _managerBrandComponent.canCreateBrands
          ? AddButtonComponent(onPressed: () => _showBrandForm())
          : null,
  ...
  Widget _buildContent() {
    if (_managerBrandComponent.isLoading &&
        _managerBrandComponent.brands.isEmpty) {
      return const Center(
        child: CircularProgressIndicator(color: VcomColors.oroLujoso),
      );
    }

    if (_managerBrandComponent.error != null &&
        _managerBrandComponent.brands.isEmpty) {
      return Center(
        child: Column(
        ...
        Expanded(
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final category = _managerBrandComponent.categories.firstWhere(
                (c) => c.idCategory == brand.idCategory,
