...
class VcomColors {
  ...
  // ============================================================================
  // TONOS BASE (FONDOS Y ATMÓSFERA) - VERSIÓN OSCURA
  // ============================================================================

  /// Azul Zafiro Profundo - Fondo Principal
  /// Es el color dominante del fondo, un azul muy oscuro que sugiere el cielo nocturno.
  /// Versión más oscura: RGB: 4, 12, 28
  static const Color azulZafiroProfundo = Color.fromRGBO(4, 12, 28, 1.0);
  ...
  /// Versión más oscura: RGB: 1, 6, 15
  static const Color azulNocheSombra = Color.fromRGBO(1, 6, 15, 1.0);
  ...
  /// Versión más oscura: RGB: 10, 20, 40
  ...
  /// Versión más oscura: RGB: 2, 8, 18
  static const Color azulMedianocheTexto = Color.fromRGBO(2, 8, 18, 1.0);
